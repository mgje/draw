...
SVGLogo = function(opts) {
   ...
   var zahn_u_m =r.path("M298,464.2c-7.6,0-13.9,6.3-13.9,13.9l0,14.1H312l0-14.2C311.9,470.4,305.7,464.2,298,464.2z").attr({fill: '#FFFFFF'});
   var zahn_u_l =r.path("M259.5,458.7c-7.1,0-13.1,5.5-13.8,12.4l27.7,20.2l0-18.7C273.4,464.9,267.2,458.7,259.5,458.7z").attr({fill: '#FFFFFF'});
   var zahn_u_r =r.path("M336.5,456.3c-7.6,0-13.9,6.3-13.9,13.9l0,20.5l27.8-20.2l0-0.4C350.4,462.5,344.2,456.3,336.5,456.3z").attr({fill: '#FFFFFF'});

   var zahn_o_m =r.path("M298.1,388.8L298.1,388.8c7.6,0,13.9-6.3,13.9-13.9l0-23.1h-27.8l0,23.1C284.2,382.6,290.4,388.8,298.1,388.8z").attr({fill: '#FFFFFF'});
   var zahn_o_l =r.path("M336.6,387.1L336.6,387.1c7.5,0,13.7-6.1,13.9-13.6l-27.8-20.2l0,19.9C322.6,380.9,328.9,387.1,336.6,387.1z").attr({fill: '#FFFFFF'});
   var zahn_o_r =r.path("M259.6,383.5L259.6,383.5c7.6,0,13.9-6.3,13.9-13.9l0-16.7L246,372.7C247.5,378.9,253,383.5,259.6,383.5z").attr({fill: '#FFFFFF'});

   var rand =r.path("M382.6,360.3l-52.5-38.1h-64.9l-52.5,38.1l-20,61.7l20,61.7l52.5,38.1h64.9l52.5-38.1l20-61.7L382.6,360.3z M350.4,470.5l-27.8,20.2l-2.1,1.6H312h-27.8h-9.3l-1.4-1l-27.7-20.2l-7.8-5.7L223.8,422l14.1-43.4l8.1-5.9l27.4-19.9l1.4-1h9.3h27.8h8.6l2.1,1.5l27.8,20.2l7,5.1l14.1,43.4l-14.1,43.4L350.4,470.5z").attr({fill: '#D55734'});
   var b1_b =r.path("M251.5,431.2c0,7.3-5.4,12.1-15.2,12.1H209v-10.5h4.1v-21.7H209v-10.4h25.6c9.4,0,15,4.6,15,11.4c0,3.7-1.9,8-5.8,9.5C248.7,422.7,251.5,427,251.5,431.2z M226.2,417.7h5.7c3,0,4.6-1.4,4.6-3.5c0-2.3-1.6-3.3-4.6-3.3h-5.6V417.7z M233.2,433.1c3.5,0,5-1.3,5-3.6c0-2.1-1.3-3.2-4.8-3.2h-7.2v6.8H233.2z").attr({fill: '#FFFFFF'});
   var b2_y =r.path("M283.5,432.9h5.6v10.5h-24.4v-10.5h5.6V432l-11.3-20.9h-6.1v-10.4h21.7v10.4h-1.1l3.3,6.1l3.3-6.1h-1v-10.4h21.7v10.4h-6L283.5,432V432.9z").attr({fill: '#FFFFFF'});
   var b3_t =r.path("M345.6,417.6h-10.5v-5.5H331v20.8h6.5v10.5h-26v-10.5h6.5v-20.8h-4.2v5.5h-10.5v-16.8h42.4V417.6z").attr({fill: '#FFFFFF'});
   var b4_e =r.path("M386,415.3h-10.5v-3.6h-9.7v5.4h14.1v10h-14.1v5.4h9.7v-3.6H386v14.5h-37.3v-10.5h4.1v-21.7h-4.1v-10.4H386V415.3z").attr({fill: '#FFFFFF'});
